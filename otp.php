...
<br>
 ...
 <p class="w3-opacity" style="text-align: center; font-size: 40px;font-family: tahoma;margin-right: 0px;margin-top: -100px;color: black">SELLER INFORMATION</p>

      <form class="w3-container w3-card w3-padding-32 w3-white"; style="margin-left: 10%;margin-right: 10%" margin-down: 555px; action="otp1.php" method="POST">
...
<br>
        ...
        <h4 style="text-align: center"><span style="text-align: center"><button type="submit" name="sendotp" class="w3-button" style="background-color: red;width: 135px">Send OTP</button></span>
   </form>
