...
<a href="otp.php" class="w3-bar-item">
...
<script>
  ...
  <a href="otp.php"><img src="dp3.png" style="width: 90px;margin-left: 0px;margin-top: -10px"></a>  
...
<?php
	...
	if($verotp==$_COOKIE['otp']) {
		echo("YOUR MOBILE IS SUCCESSFULLY VERIFIED");
	}else {
		echo("PLEASE ENTER YOUR CORRECT OTP");
	}
}
...
<form method="POST"  action="otpv.html">  


	<div class="w3-section">
          <label style="margin-left: -1%;font-size: 16px"></label>
          <input class="w3-input" style="width:55%;margin-left: 22%;font-size: 15px;font-family: tahoma;color:black" type="text" placeholder="Enter your OTP">
        </div>
	...
	<h4 style="text-align: center"><span style="text-align: center"><button type="submit" name="verifyotp" class="w3-button" style="background-color: red;width: 135px">View Details</button></span>
