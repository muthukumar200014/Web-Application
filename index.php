             ...
             <div class="login">
                  <div id="login" class="w3-modal">
                        <div class="w3-modal-content w3-animate-zoom " style="width: 50%">
             		     ...
             		     <form class="w3-container w3-card w3-padding-32 w3-black" action="process.php" method="POST">
	              		 ...
	              		 function Toggle() {
  	             		 ...
  	             		 x.type = "password";
                    	      ...
                    	      <h4 style="text-align: center"><span style="text-align: center"><a href="process.php"><button type="submit" name="submit1" class="w3-button" style="background-color: red;width: 110px;color:white">Login</button></a></span></h4>
                                         </form>
...
<br>
        ...
        <div class="line" style="border: 0.5px solid black;margin-top: -20px">
        </div>
        ...
        <!-- CATEGORY-->
         ...
         <h4 style="text-align: center;margin-top: 0px">Category</h4>
         <br>
         <div class="row">
              <div class="column1">
...
<div class="w3-main" style="margin-left:205px"> 
		...
		<div id="demo" class="carousel slide" data-ride="carousel">
     			...
     			<div class="carousel-item active">
     			        <a href=""><img src="slider1.jpg" alt="Los Angeles" width="1100" height="500"></a>
    		  	</div>
    			<div class="carousel-item">
      			         <a href=""><img src="slider2.jpg" alt="Chicago" width="1100" height="500"></a>
   			</div>
    			<div class="carousel-item">
      			          <a href=""><img src="slider3.jpg" alt="New York" width="1100" height="500"></a>
    			</div>
  		         </div>
         ...
         <div class="w3-main" style="margin-left:10px">
				...
				<?php
						...
						if ($min!=0 && $max!=0 && $min<=$max) {
								$res=mysqli_query($link,"SELECT * from images WHERE price BETWEEN '$min' and '$max' ORDER BY id DESC");
				...
				<?php
						...
						<?php } }
						elseif($min>$max){
							echo "<script type='text/javascript'>alert('Enter the correct values.');window.location.href='index.php';</script>";
						}	}
						
							else {
							$res=mysqli_query($link,"SELECT * from images ORDER BY id DESC");
								foreach ($res as $image1) {
								$temp = $image1["image"];
								$b = str_replace(',', ' ', $temp );
								$str_arr = explode(" ", $b); 
...
<div class="w3-black w3-center w3-padding-24">Powered by <a href="https://www.w3schools.com/w3css/default.asp" title="Appkart" target="_blank" class="w3-hover-opacity">Appkart</a></div>
	<br>
</div>
...
function clic(key) {
  window.location.replace("/viewmore.html?id='"+key+"'");
